...
prompt = "Generate the content for the first page of a report on vibration testing, don't use * to high light text and leave space for adding charts in each page but from the second page."
...
async def main():
    ...
    create_pdf(generated_text, "vibration_report.pdf")
